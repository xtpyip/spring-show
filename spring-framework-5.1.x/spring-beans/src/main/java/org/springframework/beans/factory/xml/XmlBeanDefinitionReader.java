...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
		...
		Set<EncodedResource> currentResources = this.resourcesCurrentlyBeingLoaded.get();// this.resourcesCurrentlyBeingLoaded:NamedThreadLocal
		...
		try {
			InputStream inputStream = encodedResource.getResource().getInputStream();// encodedResource:class path resource [applicationContext.xml]
			try {
	...
	public XmlReaderContext createReaderContext(Resource resource) {
		return new XmlReaderContext(resource, this.problemReporter, this.eventListener,
				this.sourceExtractor, this, getNamespaceHandlerResolver());// ⾸先完成了 NamespaceHandlerResolver 的初始化
	}
